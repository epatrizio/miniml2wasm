typing error:
  ...
  scope analysing ...
  typechecking ...
  Typechecking error: File "export.mml", line 2, char 0: local scope export functions are not allowed
  ...
  $ dune exec miniml2wasm -- fun_rec_1.mml
  parsing ...
  scope analysing ...
  ident: fun_rec not found or not in current scope
  $ dune exec miniml2wasm -- fun_rec_2.mml
  parsing ...
  scope analysing ...
  typechecking ...
  Typechecking error: File "fun_rec_2.mml", line 3, char 2: attempt to perform a function call with non uniform argument types!
