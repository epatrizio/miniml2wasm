typing error:
  ...
  scope analysing ...
  typechecking ...
  Typechecking error: File "binop_min.mml", line 3, char 8: attempt to perform an arithmetic binop '-' on a non i32 types
  ...
  scope analysing ...
  typechecking ...
  Typechecking error: File "global_binop.mml", line 3, char 8: attempt to perform an arithmetic binop '*' on a non i32 types
